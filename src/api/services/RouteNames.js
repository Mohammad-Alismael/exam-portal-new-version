...
export const FETCH_EXAMS_STUDENT = '/exam/students'
...
export const FETCH_EXAM_DETAILS_STUDENT = '/exam/details'
export const FETCH_EXAM_QUESTIONS = '/question'
export const FETCH_EXAM_QUESTIONS_STUDENT = '/question/student'
export const DELETE_QUESTION = '/question/delete'
export const UPDATE_EXAM_QUESTION = '/question'
export const SUBMIT_USER_ANSWER = '/user-answer'
...
export const FETCH_NOTIFICATIONS = '/notification'
export const UPDATE_ALL_NOTIFICATIONS = '/notification/all'
export const UPDATE_SINGLE_NOTIFICATION = '/notification'