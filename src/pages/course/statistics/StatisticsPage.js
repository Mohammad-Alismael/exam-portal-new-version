...
import {Container, Graph1, Graph2, QuestionsContainer} from "./StatisticsPage.styles";
import {Typography} from "@mui/material";
import QuestionsStats from "./QuestionStats/QuestionsStats";

const StatisticsPage = () => {
    const components = new Array(10).fill().map((_, i) => <QuestionsStats key={i}/>);
...
export default withSideBarAndResAppBar(StatisticsPage);